...
export default function WhyChooseUsPage() {
  const supplierFaqs = [
    ...
    { question: "How long does delivery take?", answer: "Manchester same-day / next-day delivery for in-stock items. UK-wide standard delivery is 1-3 business days. Colour-matched or custom orders typically 3-5 business days." },
    ...
    { question: "What methods do you supply?", answer: "We supply full product lines in: Clip-In, Tape-In, Nano Ring (Micro Ring), K-Tip (I-Tip), Hand-Tied Weft, and Butterfly Weft - plus Hair Toppers and Ponytails. See our collections for the full range." },
    { question: "Do you ship outside the UK?", answer: "Yes - we ship throughout the EU and internationally. EU delivery is typically 3-5 business days. Contact us for a shipping quote on international orders." },
  ]

  return (
    <CartProvider>
      <>
        <FaqJsonLd faqs={supplierFaqs} />
