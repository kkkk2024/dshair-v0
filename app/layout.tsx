...
export const metadata: Metadata = {
  ...
  description: "Manchester-based B2B wholesale supplier of 100% Remy human hair extensions for professional salons. Tape-In, K-Tip, Weft, Butterfly Weft & Toppers. Trade pricing — apply for access. 19+ years industry experience.",
  keywords: [
    ...
    'remy human hair extensions trade', 'hair extension supplier Manchester',
    'human hair extensions wholesale', 'salon supplier Manchester', 'B2B hair extensions UK',
    'wholesale hair supplier UK',
  ],
