            ...
            <p>
              ...
              <div className="bg-primary/5 border border-primary/10 rounded-xl p-6 my-8 not-prose">
                ...
                <p className="text-muted-foreground text-sm mb-4">
                  DS Hair & Beauty supplies trade-grade 100% Remy human hair extensions to professional salons across the UK & EU. factory-direct express 3–5 day shipping, trade pricing, and free digital colour catalogue with your first order. Apply for your trade account today.
                </p>
