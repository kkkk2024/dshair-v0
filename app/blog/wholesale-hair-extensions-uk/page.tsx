...
export const metadata = {
 ...
 alternates: {
  ...
  languages: hreflangAlternates("/blog/wholesale-hair-extensions-uk"),
 },
}
...
export default function WholesaleHairExtensionsUK() {
 return (
  <CartProvider>
   <BlogJsonLd slug="wholesale-hair-extensions-uk" />
     ...
     <FaqJsonLd
      faqs={[
       ...
       },
       {
        ...
        answer:
         "Selected lines ship factory-direct,with broader range shipped factory-direct via express courier in 3–5 days (DHL/UPS). This lets salons reorder as needed without holding large stock.",
       },
       {
        question: "What should I look for in a UK wholesale supplier?",
        answer:
         "100% Remy human hair as standard,40+ colour options,no minimum order,trade accounts with clear terms,direct contact support,and paid sample packs so you can verify quality before a large order. Avoid suppliers who cannot show consistent grade across batches.",
       },
      ]}
     />
     ...
     <article className="max-w-4xl mx-auto px-4 md:px-6 py-16">
      ...
      <div className="prose prose-lg max-w-none">
       ...
       <ul className="list-disc pl-6 space-y-2 text-lg text-muted-foreground mb-8">
        ...
        <li><strong> + express 3–5 day factory-direct shipping</strong> — avoids long customs delays while keeping a wide range available</li>
        ...
        <li><strong>Paid sample packs before full commitment</strong> — ethical suppliers are confident in their quality</li>
       </ul>

       {/* ── What DSB Offers ─────────────────────── */}
       <h2 className="font-serif text-3xl md:text-4xl font-medium mt-12 mb-6">What D.S Hair Beauty Offers to UK Trade Buyers</h2>
       <p className="text-lg text-muted-foreground leading-relaxed mb-6">
        D.S Hair Beauty is a factory-direct wholesale hair extension supplier with 19 years of experience supplying UK salons. We are hair professionals ourselves — so we understand what salon owners and stylists actually need. Selected factory-direct express 3–5 day shipping.
       </p>
       <p className="text-lg text-muted-foreground leading-relaxed mb-6">
       ...
       <div className="not-prose space-y-4 mb-12">
        ...
        <div className="border border-amber-100 rounded-xl p-5 bg-[#FDF8F0]">
         ...
         <p className="text-sm text-[#6B3A6E] leading-relaxed">Selected lines ship factory-direct,with broader range shipped factory-direct via express courier in 3–5 days (DHL/UPS).</p>
        </div>
        <div className="border border-amber-100 rounded-xl p-5 bg-[#FDF8F0]">
         <p className="font-semibold text-[#4A1942] mb-2">What should I look for in a UK wholesale supplier?</p>
         <p className="text-sm text-[#6B3A6E] leading-relaxed">100% Remy human hair as standard,40+ colour options,no minimum order,trade accounts with clear terms,direct contact support,and paid sample packs.</p>
        </div>
       </div>
