...
import { clientStoryStylistToFounderContent, type Span } from "@/lib/i18n/blog/client-story-stylist-to-founder"
...
export function ClientStoryStylistToFounderView({ locale }: { locale: Locale }) {
  const c = clientStoryStylistToFounderContent[locale]

  return (
    <CartProvider>
      <BlogJsonLd slug="client-story-stylist-to-founder" locale={locale} />
      <div className="flex min-h-screen flex-col">
        ...
        <main className="flex-1">
          ...
          <article className="max-w-4xl mx-auto px-4 md:px-6 py-16">
            <div className="prose prose-lg max-w-none">
              ...
              <BlogFaqSection slug="client-story-stylist-to-founder" title={c.faqHeading} locale={locale} />
        ...
        <RelatedGuides slug="client-story-stylist-to-founder" locale={locale} />
        <Footer />
        <CartDrawer />
      </div>
    </CartProvider>
