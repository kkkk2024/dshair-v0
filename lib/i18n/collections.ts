...
const en: CollectionContent = {
  all: {
    ...
    seoDescription: 'Shop 100% Remy human hair extensions wholesale for salons. Clip-in, tape-in, weft & more. Express UK delivery, trade pricing available.',
  ...
  diy: {
    ...
    seoDescription: 'Premium DIY hair extensions for home use. Salon-quality clip-in & tape-in sets in 50+ shades. Express UK delivery, 30-day returns.',
  ...
  professional: {
    ...
    seoDescription: 'Professional hair extensions for salons & stylists. Wholesale pricing, bulk orders, trade accounts. Expert support & express UK delivery.',
  ...
  'clip-in': {
    ...
    seoDescription: 'Salon-quality clip-in hair extensions in 50+ shades. 100% Remy human hair, easy at-home application. Express UK delivery & 30-day returns.',
  ...
  'tape-in': {
    ...
    seoDescription: 'Ultra-thin seamless tape hair extensions for salons. Heat-friendly bonds, invisible application. Wholesale pricing, express UK delivery.',
  ...
  ponytails: {
    ...
    seoDescription: 'Human hair ponytail extensions in 30+ styles. Instant length & volume, no appointment needed. 100% Remy hair, express UK delivery.',
  ...
  weft: {
    ...
    seoDescription: 'Weft hair extensions for salons: hand-tied & machine weft. Premium Remy hair, seamless bulk pricing. Express UK delivery for trade orders.',
  ...
  'extension-care': {
    ...
    seoDescription: 'Prolong your hair extensions with salon-recommended care products. Sulfate-free shampoo, conditioner, brushes & more. Express UK delivery over £30.',
  ...
  'extension-tools': {
    ...
    seoDescription: 'Professional hair extension installation tools: pliers, micro rings, heat tongs & removal kits. Salon-grade quality, express UK delivery.',
  ...
  storage: {
    ...
    seoDescription: 'Hair extension storage bags & velvet organisers. Keep extensions tangle-free & protected. Premium quality, express UK delivery.',
  },
  'butterfly-extensions': {
    ...
    seoDescription: 'Butterfly weft extensions — the ultra-thin 0.5mm industry game-changer. Seamless finish for salons. Wholesale pricing, express UK delivery.',
...
const fr: CollectionContent = {
  all: {
    ...
    seoDescription: 'Achetez des extensions 100% Remy en gros pour salons. Clip-in, tape-in, weft & plus. Livraison express gratuite UK, prix professionnels disponibles.',
  ...
  diy: {
    ...
    seoDescription: 'Extensions DIY premium pour usage domestique. Sets clip-in & tape-in de qualité salon en 50+ nuances. Livraison express gratuite UK, retours 30 jours.',
  ...
  'clip-in': {
    ...
    seoDescription: 'Extensions clip-in de qualité salon en 50+ nuances. 100% Remy, application facile à domicile. Livraison express gratuite UK & retours 30 jours.',
  ...
  weft: {
    ...
    seoDescription: 'Extensions weft pour salons : hand-tied & machine. Cheveux Remy premium, tarifs vrac sans couture. Livraison express gratuite UK pour commandes trade.',
  ...
  'extension-care': {
    ...
    seoDescription: 'Prolongez la durée de vie des extensions avec des produits de soin recommandés par les salons. Shampooing sans sulfate, conditioner, brosses & plus. Livraison express gratuite UK dès £30.',
...
const ar: CollectionContent = {
  all: {
    ...
    seoDescription: 'تسوق إكسسوارات شعر 100% ريمي طبيعي بالجملة للصالونات. كليب-إن، تيب-إن، ويفت والمزيد. توصيل مجاني سريع UK، أسعار تجارية متاحة.',
  ...
  diy: {
    ...
    seoDescription: 'إكسسوارات شعر DIY ممتازة للاستخدام المنزلي. أطقم كليب-إن وتيب-إن بجودة الصالون في 50+ درجة لون. توصيل مجاني سريع UK، إرجاع خلال 30 يومًا.',
  ...
  professional: {
    ...
    seoDescription: 'إكسسوارات شعر احترافية للصالونات والمصففين. أسعار الجملة، طلبات بالجملة، حسابات تجارية. دعم خبير وتوصيل مجاني سريع UK.',
  ...
  'clip-in': {
    ...
    seoDescription: 'إكسسوارات كليب-إن بجودة الصالون في 50+ درجة لون. 100% ريمي طبيعي، سهل التركيب في المنزل. توصيل مجاني سريع UK وإرجاع 30 يومًا.',
  ...
  'tape-in': {
    ...
    seoDescription: 'إكسسوارات تيب رفيعة وبدون خياطة للصالونات. لاصقات مقاومة للحرارة، تركيب غير مرئي. أسعار الجملة، توصيل مجاني سريع UK من £50.',
  ...
  ponytails: {
    ...
    seoDescription: 'إكسسوارات ذيل حصان من شعر طبيعي بـ 30+ نمط. طول وحجم فوريان بدون موعد. 100% ريمي، توصيل مجاني سريع UK.',
  ...
  weft: {
    ...
    seoDescription: 'إكسسوارات ويفت للصالونات: مصنوعة يدويًا وآليًا. شعر ريمي ممتاز، أسعار جملة بدون خياطة. توصيل مجاني سريع UK للطلبات التجارية.',
  ...
  'extension-care': {
    ...
    seoDescription: 'مدّد عمر الإكسسوارات بمنتجات عناية موصى بها من الصالونات. شامبو خالٍ من الكبريتات، بلسم، فرش والمزيد. توصيل مجاني سريع UK من £30.',
  ...
  'extension-tools': {
    ...
    seoDescription: 'أدوات تركيب إكسسوارات احترافية: ملقط، حلقات صغيرة، ملاقط ساخنة ومجموعات إزالة. جودة الصالون، توصيل مجاني سريع UK.',
  ...
  storage: {
    ...
    seoDescription: 'أكياس ومنظمات مخملية للإكسسوارات. حافظ على الإكسسوارات خالية من العقد ومحمية. جودة ممتازة، توصيل مجاني سريع UK.',
  },
  'butterfly-extensions': {
    ...
    seoDescription: 'باترفلاي ويفت — ثورة 0.5 ملم في الصناعة. إنهاء بدون خياطة للصالونات. أسعار الجملة، توصيل مجاني سريع UK.',
...
const plLoc: CollectionContent = {
  all: {
    ...
    seoDescription: 'Kupuj 100% Remy ludzkie przedłużenia włosów hurtowo dla salonów. Clip-in, tape-in, weft i więcej. Darmowa ekspresowa dostawa UK, ceny handlowe dostępne.',
  ...
  diy: {
    ...
    seoDescription: 'Premium DIY przedłużenia włosów do użytku domowego. Zestawy clip-in i tape-in w jakości salonowej w 50+ odcieniach. Darmowa ekspresowa dostawa UK, zwrot do 30 dni.',
  ...
  'clip-in': {
    ...
    seoDescription: 'Clip-iny w jakości salonowej w 50+ odcieniach. 100% Remy, łatwa aplikacja w domu. Darmowa ekspresowa dostawa UK i zwrot 30 dni.',
  ...
  weft: {
    ...
    seoDescription: 'Przedłużenia weft dla salonów: ręcznie wiązane i maszynowe. Premium włosy Remy, bezszwowe ceny hurtowe. Darmowa ekspresowa dostawa UK dla zamówień handlowych.',
  ...
  'extension-care': {
    ...
    seoDescription: 'Wydłuż żywotność extensions dzięki produktom pielęgnacyjnym rekomendowanym przez salony. Szampon bez siarczanów, odżywka, szczotki i więcej. Darmowa ekspresowa dostawa UK od £30.',
