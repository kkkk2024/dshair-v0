...
export const findStylistContent: Record<Locale, FindStylistContent> = {
  en: {
    ...
    metaDescription:
      "Find a professional hair extension stylist near you. Our UK-wide network of professional salon partners specialises in tape-in, nano ring, K-tip, and hand-tied weft extensions.",
    ...
    benefits: [
      ...
      },
      {
        ...
        description:
          "Simple 3-minute application. No fees, no obligations. Verified stylists are listed in our directory.",
      },
    ],
    ...
    locationPlaceholder: "e.g. your city",
  ...
  de: {
    ...
    locationPlaceholder: "z. B. deine Stadt",
  ...
  fr: {
    ...
    locationPlaceholder: "ex. votre ville",
  ...
  ar: {
    ...
    locationPlaceholder: "مثال: مدينتك",
  ...
  sv: {
    ...
    locationPlaceholder: "t.ex. votre ville",
  ...
  pl: {
    ...
    locationPlaceholder: "np. twoje miasto",
