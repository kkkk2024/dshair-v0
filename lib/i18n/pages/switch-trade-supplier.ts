...
export const switchContent: Record<Locale, SwitchContent> = {
  en: {
    ...
    compareRows: [
      ...
      { feature: "UK delivery", competitor: "Depends on supplier", ds: "Express 3–5 day factory-direct delivery from our manufacturing partner" },
    ...
    valueBlocks: [
      ...
      { title: "Reliable Supply", desc: "Full range shipped via express DHL/UPS from our manufacturing partner to the UK & EU." },
  ...
  de: {
    ...
    compareRows: [
      ...
      { feature: "UK-Lieferung", competitor: "Hängt vom Lieferanten ab", ds: "Express 3–5 Tage Factory-Direct-Lieferung von unserem Fertigungspartner" },
    ...
    valueBlocks: [
      ...
      { title: "Verlässliche Versorgung", desc: "Gesamtes Sortiment per Express DHL/UPS von unserem Fertigungspartner nach UK & EU." },
  ...
  fr: {
    ...
    compareRows: [
      ...
      { feature: "Livraison UK", competitor: "Dépend du fournisseur", ds: "Livraison express 3–5 jours factory-direct depuis notre partenaire" },
    ...
    valueBlocks: [
      ...
      { title: "Approvisionnement fiable", desc: "Gamme complète expédiée en express DHL/UPS depuis notre partenaire vers le UK & UE." },
  ...
  ar: {
    ...
    compareRows: [
      ...
      { feature: "تسليم UK", competitor: "حسب المورد", ds: "تسليم اكسبرس 3–5 أيام factory-direct من شريكنا" },
    ...
    valueBlocks: [
      ...
      { title: "توريد موثوق", desc: "كامل النطاق عبر DHL/UPS اكسبرس من شريكنا إلى UK & UE." },
  ...
  sv: {
    ...
    compareRows: [
      ...
      { feature: "UK-leverans", competitor: "Beror på leverantör", ds: "Express 3–5 dagar factory-direct från vår tillverkningspartner" },
    ...
    valueBlocks: [
      ...
      { title: "Tillförlitlig leverans", desc: "Hela sortimentet via express DHL/UPS från vår tillverkningspartner till UK & EU." },
  ...
  pl: {
    ...
    compareRows: [
      ...
      { feature: "Dostawa UK", competitor: "Zależy od dostawcy", ds: "Ekspres 3–5 dni factory-direct od naszego partnera" },
    ...
    valueBlocks: [
      ...
      { title: "Niezawodne zaopatrzenie", desc: "Pełna gama przez ekspres DHL/UPS od naszego partnera do UK & UE." },
