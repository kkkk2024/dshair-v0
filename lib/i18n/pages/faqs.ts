    ...
    categories: [
      {
        ...
        faqs: [
          ...
          { q: "Wie sieht Ihre Versand- und Rücksendungsrichtlinie aus?", a: "Express UK-Versand ab £175, per Express (3-5 Tage). Internationaler Versand möglich. Rücksendungen innerhalb von 30 Tagen für unbenutzte Artikel in Originalverpackung akzeptiert. Details finden Sie auf unserer Seite für Versand & Rücksendungen." },
    ...
    categories: [
      {
        ...
        faqs: [
          ...
          { q: "Quelle est votre politique d'expédition et de retours ?", a: "Livraison express UK dès £175, par express (3-5 jours). Expédition internationale disponible. Retours acceptés sous 30 jours pour les articles non utilisés dans leur emballage d'origine. Voir notre page complète expédition & retours pour les détails." },
