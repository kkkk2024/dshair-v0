...
const BENEFITS_EN = [
  ...
  { title: "Express Factory-Direct Supply", desc: "factory-direct express (3–5 days) shipping across the full range. No waiting weeks for stock.", highlight: false },
...
export const salonPartnerContent: Record<Locale, SalonPartnerContent> = {
  en: {
    ...
    form: {
      ...
      locationPh: "e.g. your city / Salford",
      email: "Email Address *",
  ...
  de: {
    ...
    heroSubtitle:
      "Treten Sie unserem wachsenden UK- & EU-Netzwerk professioneller Salons bei. Erhalten Sie Großhandelspreise für 100 % Remy-Menschenhaar – mit Express-Factory-Direct (3–5 Tage).",
    ...
    benefits: [
      ...
      { title: "Express Factory-Direct", desc: "Factory-Direct-Express (3–5 Tage) für die volle Palette. Kein Wochenlanges Warten.", highlight: false },
    ...
    form: {
      ...
      locationPh: "z. B. deine Stadt / Salford",
  ...
  fr: {
    ...
    benefits: [
      ...
      { title: "Express factory-direct", desc: "express factory-direct (3–5 jours) pour toute la gamme. Pas d'attente de semaines.", highlight: false },
    ...
    form: {
      ...
      locationPh: "ex. votre ville / Salford",
  ...
  ar: {
    ...
    benefits: [
      ...
      { title: "مباشر من المصنع وشحن سريع", desc: "شحن سريع مباشر (3–5 أيام) لكامل المجموعة. لا انتظار أسابيع.", highlight: false },
    ...
    form: {
      ...
      locationPh: "مثال: مدينتك / Salford",
  ...
  sv: {
    ...
    heroSubtitle:
      "Gå med i vårt växande nätverk av proffssalonger i Storbritannien & EU. Få partipriser på 100 % Remy — med express factory-direct (3–5 dagar).",
    ...
    benefits: [
      ...
      { title: "Express factory-direct", desc: "factory-direct express (3–5 dagar) för hela sortimentet. Ingen veckoväntan.", highlight: false },
    ...
    form: {
      ...
      locationPh: "t.ex. votre ville / Salford",
      email: "E-postadress *",
  ...
  pl: {
    ...
    benefits: [
      ...
      { title: "Ekspres factory-direct", desc: "ekspres factory-direct (3–5 dni) na całą gamę. Bez tygodni czekania.", highlight: false },
    ...
    form: {
      ...
      locationPh: "np. twoje miasto / Salford",
      email: "Adres e-mail *",
