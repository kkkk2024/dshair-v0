...
const en: ShopUi = {
  ...
  productDetail: {
    ...
    freeDelivery: 'Express UK delivery over £50',
    ...
    freeDeliveryOver: 'Express UK Delivery over £175',
...
const fr: ShopUi = {
  ...
  productDetail: {
    ...
    freeDelivery: 'Livraison express UK dès £50',
    ...
    freeDeliveryOver: 'Livraison express UK dès £175',
...
const ar: ShopUi = {
  ...
  productDetail: {
    ...
    freeDelivery: 'توصيل سريع في UK للطلبات فوق £50',
    ...
    freeDeliveryOver: 'توصيل سريع في UK للطلبات فوق £175',
...
const pl: ShopUi = {
  ...
  productDetail: {
    ...
    freeDelivery: 'Ekspresowa dostawa UK od £50',
    ...
    freeDeliveryOver: 'Ekspresowa dostawa UK od £175',
