...
export const salonConsumables: SalonConsumable[] = [
  ...
  },
  {
    ...
    image: IMG("nano-newbie"),
    images: [IMG("nano-newbie")],
    productType: "Hair Extension Tools",
    type: "professional",
  ...
  },
  {
    ...
    image: IMG("dual-method"),
    images: [IMG("dual-method")],
    productType: "Hair Extension Tools",
    type: "professional",
  ...
  },
  {
    ...
    image: IMG("pro-upgrade"),
    images: [IMG("pro-upgrade")],
    productType: "Hair Extension Tools",
    type: "professional",
  ...
  },
  {
    ...
    features: [
      ...
      "Compare: Beauty Works £19 — you save 47%",
    ],
    image: IMG("tape-tabs"),
  ...
  },
  {
    ...
    name: "Sectioning Clips – 5pc Pack",
    slug: "sectioning-clips",
    category: "single",
    price: 5.49,
    currency: "GBP",
    description:
      "Professional crocodile sectioning clips for clean hair parting during extension installation. Strong spring, non-slip grip, 5 pieces per pack. Essential for nano ring, tape-in, and weft application. These are the clips professionals reach for every day.",
    shortDescription: "5 professional crocodile sectioning clips",
    features: [
