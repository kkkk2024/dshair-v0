...
export const products: Product[] = [
  ...
  // ─── Hair Toppers ───────────────────────────────────────────
  {
    ...
    description: "The gold standard in crown coverage. Our silk base hair topper is 100% hand-tied on a silk (lace) base — creating the world's most realistic scalp and part line. Each strand is individually inserted to mimic natural hair growth, making it virtually undetectable even in direct sunlight. Ideal for clients experiencing thinning at the crown, parting, or throughout the top. Available in 30+ salon colours, 12\"–22\" lengths, and 4 base sizes. 100% Remy human hair — can be coloured, heat-styled, and customised.",
    shortDescription: "100% hand-tied silk base. Most realistic scalp in the industry.",
    vendor: "D.S HAIR & BEAUTY",
    productType: "Hair Topper",
    type: "professional",
    tags: ["hair-topper", "silk-base", "crown-coverage", "thinning-hair", "best-seller"],
    price: 179,
    originalPrice: 219,
    currencyCode: "GBP",
    image: "/images/toppers/silk-base-hero.jpg",
    images: [
      "/images/toppers/silk-base-hero.jpg",
      "/images/toppers/silk-base-part.jpg",
      "/images/toppers/silk-base-worn.jpg",
      "/images/toppers/silk-base-flat.jpg",
      "/images/toppers/base-comparison.jpg",
      "/images/toppers/color-chart-topper.jpg",
    ],
    variants: [],
    inStock: true,
    badge: "Best Seller",
    ...
    colors: [
      ...
      { name: "Off Black #1B", hex: "#1A0F0A" },
      { name: "Dark Brown #2", hex: "#2D1810" },
      { name: "Darkest Brown #3", hex: "#3D2317" },
      { name: "Medium Brown #4", hex: "#4A2314" },
      { name: "Chestnut #8", hex: "#6B3A14" },
      { name: "Caramel #12", hex: "#9B6B3A" },
      { name: "Dark Blonde #16", hex: "#8B6914" },
      { name: "Ash Brown #10", hex: "#5C4A3A" },
      { name: "Honey Blonde #16R", hex: "#B8863A" },
      { name: "Chocolate Brown #30", hex: "#7A4A28" },
      { name: "Auburn #27", hex: "#8B4513" },
      { name: "Ginger Blonde #22", hex: "#C4822A" },
      { name: "Light Ash Blonde #18B", hex: "#C8A878" },
      { name: "Beach Blonde #60", hex: "#D4B896" },
    ],
    lengths: ["12\" (30cm)", "14\" (35cm)", "16\" (40cm)", "18\" (45cm)", "20\" (50cm)", "22\" (55cm)"],
    slug: "silk-base-hair-topper",
    category: "Hair Toppers",
    features: [
      "100% hand-tied silk (lace) base — most realistic scalp simulation",
      "Individual hair strand insertion mimics natural growth direction",
      "Invisible at the crown even in bright light or direct sun",
      "4 base sizes: Small (4\"×5\"), Medium (5\"×6\"), Large (6\"×7\"), XL (7\"×8\")",
      "Choice of single or multi-parting",
      "Pressure-sensitive clips for secure, damage-free hold",
      "100% Remy human hair — cuticle intact, directionally correct",
      "Density: 120% (light), 150% (medium), 180% (full) — please specify",
      "Heat-friendly: safe to curl, straighten, and colour",
      "Can be customised: cut, layered, and styled to blend perfectly",
      "30+ colours — free colour swatch kit available for trade customers",
    ],
    baseSize: "Small / Medium / Large / XL",
    hairWeight: "50g / 70g / 90g / 120g",
...

  {
    ...
    title: "Mono Top Hair Topper — Breathable & Versatile Parting",
    description: "The professional's choice. A breathable monofilament base with hand-tied hair at the parting zone gives clients the flexibility to wear their topper with a centre part, side part, or anywhere they choose. The mono base allows scalp ventilation for all-day comfort and superior longevity. Ideal for clients who want a natural look with more styling versatility. 100% Remy human hair in 30+ colours, 12\"–20\" lengths.",
    shortDescription: "Breathable mono base with free parting — professional's choice.",
    vendor: "D.S HAIR & BEAUTY",
    productType: "Hair Topper",
    type: "professional",
    tags: ["hair-topper", "mono-top", "breathable", "parting", "professional"],
    price: 149,
    originalPrice: 179,
    currencyCode: "GBP",
    image: "/images/toppers/mono-top-hero.jpg",
    images: [
      "/images/toppers/mono-top-hero.jpg",
      "/images/toppers/mono-top-part.jpg",
      "/images/toppers/mono-top-worn.jpg",
      "/images/toppers/mono-top-flat.jpg",
      "/images/toppers/base-comparison.jpg",
      "/images/toppers/color-chart-topper.jpg",
    ],
    variants: [],
    ...
    lengths: ["12\" (30cm)", "14\" (35cm)", "16\" (40cm)", "18\" (45cm)", "20\" (50cm)"],
    slug: "mono-top-hair-topper",
    category: "Hair Toppers",
    features: [
      "Monofilament base — each strand hand-tied at the parting for realistic simulation",
      "Free parting: centre, side, or anywhere — maximum styling versatility",
      "Open mesh construction allows scalp to breathe — cooler and more comfortable",
      "Lightweight base — ideal for all-day or everyday wear",
      "4 base sizes: Small (4\"×5\"), Medium (5\"×6\"), Large (6\"×7\"), XL (7\"×8\")",
      "Pressure clips included for secure attachment",
      "100% Remy human hair — natural movement and shine",
      "Density: 120% (light), 150% (medium), 180% (full) — please specify",
      "Heat-friendly: safe to curl, straighten, and colour",
      "Can be cut and layered to blend with client's natural hair",
      "30+ colours — free swatch kit available for trade orders",
    ],
    baseSize: "Small / Medium / Large / XL",
    hairWeight: "50g / 70g / 90g / 110g",
    baseCoverage: "Crown + Parting",
    priceOnRequest: false,
  },

  {
    ...
    title: "Mesh Base Hair Topper — Lightweight & Everyday Comfort",
    description: "Engineered for daily wear. The open lace mesh base provides maximum airflow to the scalp — the coolest and most comfortable topper option for clients who wear a topper every day. The lightweight construction sits almost weightlessly on the head while still providing full crown coverage and natural blending. Fastest blending of all base types — great for clients in a hurry. 100% Remy human hair, 30+ colours.",
    shortDescription: "Ultra-lightweight open mesh. Maximum airflow. Everyday comfort.",
    vendor: "D.S HAIR & BEAUTY",
    productType: "Hair Topper",
    type: "professional",
    tags: ["hair-topper", "mesh-base", "lightweight", "everyday", "comfort"],
    price: 119,
    originalPrice: 149,
    currencyCode: "GBP",
    image: "/images/toppers/mesh-base-hero.jpg",
    images: [
      "/images/toppers/mesh-base-hero.jpg",
      "/images/toppers/mesh-base-worn.jpg",
      "/images/toppers/mesh-base-flat.jpg",
      "/images/toppers/base-comparison.jpg",
      "/images/toppers/color-chart-topper.jpg",
    ],
    variants: [],
    ...
    lengths: ["12\" (30cm)", "14\" (35cm)", "16\" (40cm)", "18\" (45cm)"],
    slug: "mesh-base-hair-topper",
    category: "Hair Toppers",
    features: [
      "Open lace mesh base — the most breathable and lightweight topper option",
      "Maximum airflow keeps scalp cool — ideal for daily or all-day wear",
      "Lightweight construction: barely feels like it's there",
      "Fastest blending of all base types — blends naturally within minutes",
      "Full crown coverage with invisible edge attachment",
      "Pressure clips and optional adhesive strip compatibility",
      "100% Remy human hair — soft, shiny, and manageable",
      "Density: 120% (light), 150% (medium) — please specify",
      "Heat-friendly: safe to curl and straighten",
      "Can be cut to customise the hairline and shape",
      "Available in 30+ colours — free swatch kit for trade customers",
    ],
    baseSize: "Small / Medium / Large",
    hairWeight: "40g / 60g / 80g",
...

  {
    ...
    reviews: 87,
    colors: [
      { name: "Off Black", hex: "#1A0F0A" },
      { name: "Natural Black", hex: "#0D0D0D" },
      { name: "Truffle Brown", hex: "#3D2317" },
      { name: "Espresso Brown", hex: "#2D1810" },
      { name: "Mousse Brown", hex: "#4A2314" },
      { name: "Dark Caramel", hex: "#6B3A14" },
      { name: "Dusty Ash Brown", hex: "#5C4A3A" },
      { name: "Vanilla Butter Blonde", hex: "#D4B896" },
    ],
...
export const collections: Collection[] = [
...

  {
    ...
    name: "Hair Toppers",
    slug: "hair-toppers",
    description: "Professional hair toppers for thinning hair and crown coverage. Three base types: Silk Base (most natural), Mono Top (breathable & versatile), Mesh Base (lightweight everyday). 100% Remy human hair, 30+ colours, 12\"–22\" lengths. Wholesale pricing for UK & EU salons.",
