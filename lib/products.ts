...
export const products: Product[] = [
  {
    ...
    name: "Wrap Ponytail",
    title: "Wrap Ponytail",
    description: "Transform your ponytail in seconds with our premium Wrap Ponytail extension. Made with 100% Remy human hair, this wrap-around ponytail attaches seamlessly to your natural hair using a velcro base and a long hair strand that wraps around to hide the join — no clips, no glue. Whether you're after everyday glam or an event-ready look, the Wrap Ponytail adds instant length, volume and shine. Can be washed, heat styled, curled and coloured just like your own hair.",
    shortDescription: "Instant length & volume — wraps on in seconds",
    ...
    images: [
      ...
      "/images/ponytails/dsp-01/dsp-01-2.jpg",
    ...
    features: [
      "100% Remy human hair — can be heat styled, washed & coloured",
...
export const contactInfo = {
  ...
  address: "Manchester Warehouse, UK",
